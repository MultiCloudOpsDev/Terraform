...
#       "sudo mv /home/ec2-user/file200 /root/file200",

#       "sudo mv /home/ec2-user/file1 /root/file1"
#     ]
#   }
...
resource "null_resource" "run_script" {
  provisioner "remote-exec" {
    ...
    inline = [
      "echo 'hello from awsdevopsmulticlouddd' >> /home/ec2-user/file200"
    ]
  }
...
#run only when the instance changes
#     triggers = {
